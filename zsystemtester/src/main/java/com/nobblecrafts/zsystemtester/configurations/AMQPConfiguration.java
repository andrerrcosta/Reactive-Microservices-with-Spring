...
public class AMQPConfiguration {
    ...
    @Bean
    public Binding handleWaveStream(final Queue panelQueue, @Qualifier("waveStreamTopicExchange") final TopicExchange exchangeName,
    ...
    @Bean
    public Binding handleAnalyticsReport(final Queue panelQueue, @Qualifier("analyticsReportTopicExchange") final TopicExchange exchangeName,
